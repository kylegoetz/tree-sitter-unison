...
module.exports = {
  operator_expression: $ =>
    seq($._expression, alias($.symboly_id, $.operator), $._expression),
  ...
  _rewrite_type: $ => choice($.rewrite_term, $.rewrite_case, $.rewrite_type),
  _rewrite_term_like: $ => seq($._term, layoutBlock($, $.rewrite_arrow)),
  ...
  rewrite_type: $ =>
    seq(
      $.signature,
      optional(seq(repeat1($._prefix_definition_name), alias('.', $.dot))),
      $._computation_type,
      $.rewrite_arrow,
      $._layout_start,
      $._computation_type,
